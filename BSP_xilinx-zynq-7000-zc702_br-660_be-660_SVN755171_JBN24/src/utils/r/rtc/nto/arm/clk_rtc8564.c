...
RTCFUNC(init,rtc8564)(struct chip_loc *chip, char *argv[])
{
    ...
    if (fd < 0){
        ...
        error = i2c_send_data(fd, I2C_MUX_ADDR, I2C_RTC_CHANNEL);
        return 0;
    }
}
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/utils/r/rtc/nto/arm/clk_rtc8564.c $ $Rev: 754065 $")
#endif
