...
#define MX6SX_WEIM_CS0_BASE                      0x08000000  /* NOR or SRAM */
...
#define MX6SX_CCM_CSCDR2                         0x38
	...
	#define MX6SX_CCM_CHSCCDR_IPU2_DI1_PRE_CLK_SEL_MASK  (0x7 << 15)
	#define MX6SX_CCM_CHSCCDR_IPU2_DI1_PRE_CLK_SEL_OFFSET (15)
	#define MX6SX_CCM_CHSCCDR_IPU2_DI1_PODF_MASK      	(0x7 << 12)
	#define MX6SX_CCM_CHSCCDR_IPU2_DI1_PODF_OFFSET       (12)
	#define MX6SX_CCM_CHSCCDR_IPU2_DI1_CLK_SEL_MASK      (0x7 << 9)
	#define MX6SX_CCM_CHSCCDR_IPU2_DI1_CLK_SEL_OFFSET    (9)
	#define MX6SX_CCM_CHSCCDR_IPU2_DI0_PRE_CLK_SEL_MASK  (0x7 << 6)
	#define MX6SX_CCM_CHSCCDR_IPU2_DI0_PRE_CLK_SEL_OFFSET (6)
	#define MX6SX_CCM_CHSCCDR_IPU2_DI0_PODF_MASK      	(0x7 << 3)
	#define MX6SX_CCM_CHSCCDR_IPU2_DI0_PODF_OFFSET       (3)
	#define MX6SX_CCM_CHSCCDR_IPU2_DI0_CLK_SEL_MASK      (0x7)
	#define MX6SX_CCM_CHSCCDR_IPU2_DI0_CLK_SEL_OFFSET    (0)
#define MX6SX_CCM_CSCDR3                         0x3c
 	// IPU2 registers only available on i.MX6 Dual, i.MX6 Quad
  	#define MX6SX_CCM_CSCDR3_IPU2_HSP_PODF_MASK          (0x7 << 16)
 	#define MX6SX_CCM_CSCDR3_IPU2_HSP_PODF_OFFSET        (16)
 	#define MX6SX_CCM_CSCDR3_IPU2_HSP_CLK_SEL_MASK       (0x3 << 14)
 	#define MX6SX_CCM_CSCDR3_IPU2_HSP_CLK_SEL_OFFSET     (14)
...
#define MX6SX_IPU1_BASE                          0x02400000
 ...
 * QSPI
 */
#define MX6SX_QSPI1_BASE    (MX6SX_AIPS2_BASE + 0xE0000)
#define MX6SX_QSPI2_BASE    (MX6SX_AIPS2_BASE + 0xE4000)
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/startup/lib/public/arm/mx6sx.h $ $Rev: 753777 $")
#endif
