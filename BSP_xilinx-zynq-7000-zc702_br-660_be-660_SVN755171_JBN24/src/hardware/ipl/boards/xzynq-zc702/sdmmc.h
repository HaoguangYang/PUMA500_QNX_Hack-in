 ...
 */
#define SDMMC_CLK_DEFAULT	100000
 ...
 * SDMMC functions
 */
extern int sdmmc_read (xzynq_sdmmc_t *sdmmc, void *buf, unsigned blkno, unsigned blkcnt);
extern int sdmmc_init_ctrl(xzynq_sdmmc_t *sdmmc);
extern int sdmmc_init_card(xzynq_sdmmc_t *sdmmc);
extern int sdmmc_fini(xzynq_sdmmc_t *sdmmc);
